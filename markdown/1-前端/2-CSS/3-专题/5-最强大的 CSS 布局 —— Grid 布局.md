...
转载自：<https://juejin.cn/post/6854573220306255880>
...
![1-20210225170307829](/assets/最强大的CSS布局——Grid布局/1-20210225170307829.png)
...
![1-20210225170307824-4243787](/assets/最强大的CSS布局——Grid布局/1-20210225170307824-4243787.png)

Grid 布局示例：

![1-20210225170307821](/assets/最强大的CSS布局——Grid布局/1-20210225170307821.png)
...
<style>
  .wrapper {
    margin: 60px; /* 声明一个容器 */
    display: grid; /* 声明列的宽度 */
    grid-template-columns: repeat(3, 200px); /* 声明行间距和列间距 */
    grid-gap: 20px; /* 声明行的高度 */
...
![1-20210225170307824](/assets/最强大的CSS布局——Grid布局/1-20210225170307824.png)
...
![行和列](/assets/最强大的CSS布局——Grid布局/1-20210225170307837.png)
...
![网格线](/assets/最强大的CSS布局——Grid布局/1-20210225170307925-4243787.png)
...
![块级元素](/assets/最强大的CSS布局——Grid布局/1-20210225170307837-4243787.png)
...
![行内元素](/assets/最强大的CSS布局——Grid布局/1-20210225170307925.png)
...
![固定行高和列宽](/assets/最强大的CSS布局——Grid布局/1-20210225170307865.png)
...
![17389591c300e81a-20210225170307937](/assets/最强大的CSS布局——Grid布局/17389591c300e81a-20210225170307937.gif)
...
![17389591ccc256d1-20210225170307921](/assets/最强大的CSS布局——Grid布局/17389591ccc256d1-20210225170307921.gif)
...
![17389591dc05edac-20210225170308058](/assets/最强大的CSS布局——Grid布局/17389591dc05edac-20210225170308058.gif)
...
![17389591f2146e1d-20210225170308055](/assets/最强大的CSS布局——Grid布局/17389591f2146e1d-20210225170308055.gif)
...
![1-20210225170307914](/assets/最强大的CSS布局——Grid布局/1-20210225170307914.png)

### grid-template-areas 属性

[grid-area 以及 grid-template-areas 演示地址](https://codepen.io/gpingfeng/pen/RwrObEJ?editors=1100)
...
![1-20210225170307936](/assets/最强大的CSS布局——Grid布局/1-20210225170307936.png)
...
![1-20210225170308035](/assets/最强大的CSS布局——Grid布局/1-20210225170308035.png)
...
![1-20210225170308019](/assets/最强大的CSS布局——Grid布局/1-20210225170308019.png)
...
![1-20210225170308017](/assets/最强大的CSS布局——Grid布局/1-20210225170308017.png)
...
![1-20210225170308011](/assets/最强大的CSS布局——Grid布局/1-20210225170308011.png)
...
![1-20210225170308044](/assets/最强大的CSS布局——Grid布局/1-20210225170308044.png)

- end：对齐单元格的结束边缘

![1-20210225170308054](/assets/最强大的CSS布局——Grid布局/1-20210225170308054.png)

- center：单元格内部居中

![1-20210225170308085](/assets/最强大的CSS布局——Grid布局/1-20210225170308085.png)

- stretch：拉伸，占满单元格的整个宽度（默认值）

![1-20210225170308042](/assets/最强大的CSS布局——Grid布局/1-20210225170308042.png)
...
![1-20210225170308061](/assets/最强大的CSS布局——Grid布局/1-20210225170308061.png)
...
![1-20210225170308075](/assets/最强大的CSS布局——Grid布局/1-20210225170308075.png)
...
![1-20210225170308068](/assets/最强大的CSS布局——Grid布局/1-20210225170308068.png)
...
![1-20210225170308072](/assets/最强大的CSS布局——Grid布局/1-20210225170308072.png)
...
![1-20210225170308082](/assets/最强大的CSS布局——Grid布局/1-20210225170308082.png)

- end：对齐单元格的结束边缘

![17389592a0d5a3c0](/assets/最强大的CSS布局——Grid布局/17389592a0d5a3c0.png)

- center：单元格内部居中

  ![1-20210225170308078](/assets/最强大的CSS布局——Grid布局/1-20210225170308078.png)

- stretch：拉伸，占满单元格的整个宽度（默认值）

  ![1-20210225170308239](/assets/最强大的CSS布局——Grid布局/1-20210225170308239.png)
...
![17389592bf7e44dd-20210225170308496](/assets/最强大的CSS布局——Grid布局/17389592bf7e44dd-20210225170308496.gif)
...
![17389592c297495a-20210225170308400](/assets/最强大的CSS布局——Grid布局/17389592c297495a-20210225170308400.gif)
...
![auto-auto-minmax.gif](/assets/最强大的CSS布局——Grid布局/17389592cc3c2bf9-20210225170308310.gif)
...
![17389592f9da3763-20210225170308517](/assets/最强大的CSS布局——Grid布局/17389592f9da3763-20210225170308517.gif)
...
![17389593009f7fe7-20210225170308683](/assets/最强大的CSS布局——Grid布局/17389593009f7fe7-20210225170308683.gif)
...
![1-20210225170308348](/assets/最强大的CSS布局——Grid布局/1-20210225170308348.png)
